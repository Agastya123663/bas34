...
import {
  ...
  export default class DetailsScreen extends React.Component{
    ...
    addNotifications=()=>{
      var message = this.state.userName  + " has shown interest in exchanging your item with their item"
    ...
    render(){
      return(
        <View style={styles.container}>
          ...
          <View style={{flex:0.3}}>
            <Card
              title={" Information of person who owns this item"}
              titleStyle= {{fontSize : 20}}
              >
              <Card>
          ...
          <View style={styles.buttonContainer}>
            {
              ...
              ?(
                <TouchableOpacity
                  ...
                  <Text>I want to Exchange this item with my item</Text>
                </TouchableOpacity>
              )
              : null
            }
          ...
          <View>
            <Text style={{textAlign:"center", fontWeight:'bold'}}>*By seeing the details of the person who has put up this item , you can call or text him to about the item that you want to exchange*</Text>
          </View>
        </View>
      )
    }
